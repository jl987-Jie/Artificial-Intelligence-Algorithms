...
$(function() {
    ...
    $algo_type.change(function() {
        var algo_val = $(this).val();
        if (algo_val == "astar") {
...
function GraphSearch($graph, options, implementation) {
    ...
    this.opts = $.extend({wallFrequency:0.15, debug:true, gridSize:20}, options);
    this.initialize();
}
...
// set the graph algo type
GraphSearch.prototype.setSearch = function(opt) {
    this.search = opt;
};
